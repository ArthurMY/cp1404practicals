...
from prac_07.programming_langurage import ProgrammingLanguage
...
def main():
    ...
    for line in in_file:
        ...
        reflections = parts[4] == "Yes"
        language = ProgrammingLanguage(parts[0], parts[1], reflection, int(parts[3]), reflections)
...
def using_csv_namedtuple():
    ...
    in_file = open("languages.csv", "r")
    in_file.readline()
    for language in map(Language._make, csv.reader(in_file)):    # map ==> mapping the data that you retreat
